...
@Component({
  selector: 'app-dev-extreme-component',
  templateUrl: './dev-extreme-component.component.html',
  styleUrls: ['./dev-extreme-component.component.scss']
})
export class DevExtremeComponentComponent implements OnInit {
